...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        */
        ...
        lightingShader.setVec3("pointLights[0].diffuse", 0.8f, 0.1f, 0.1f);
        ...
        lightingShader.setVec3("pointLights[1].diffuse", 0.8f, 0.1f, 0.1f);
        ...
        lightingShader.setVec3("pointLights[2].diffuse", 0.8f, 0.1f, 0.1f);
        ...
        lightingShader.setVec3("pointLights[3].diffuse", 0.8f, 0.1f, 0.1f);
